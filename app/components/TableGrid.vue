    ...
    <div :style="{ height: `${totalSize}px` }">
      <div class="relative text-xs">
        ...
        <div class="relative -mt-px" :style="{ height: `${totalSize}px` }">
          <div v-for="vRow in virtualRows" :ref="measureElement" :key="rows[vRow.index]!.id" :data-index="vRow.index" class="flex absolute w-full gap-px h-8 box-border border-t border-zinc-100" :style="{ transform: `translateY(${vRow.start}px)` }">
            <div
